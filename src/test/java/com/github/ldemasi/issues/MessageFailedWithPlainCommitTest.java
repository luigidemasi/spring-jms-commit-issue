...
import com.github.ldemasi.issues.support.CustomDoSendWithPlainCommitJmsTemplate;
...
public class MessageFailedWithPlainCommitTest {
    ...
    @Test
    public void messageFailedTest() throws IOException, URISyntaxException, InterruptedException, JSONException {
        ...
        Assertions.assertThat(actualMessagesCount).isEqualTo(0);
    }

    private JmsTemplate jmsTemplate(Destination destination){
        CustomDoSendWithPlainCommitJmsTemplate jmsTemplate = new CustomDoSendWithPlainCommitJmsTemplate();
